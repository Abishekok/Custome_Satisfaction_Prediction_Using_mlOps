...
def main():
    ...
    st.markdown(
        """ 
    Above is a description of the pipeline: we first ingest the data, clean it, train the model, and evaluate the model. If the data source changes or any hyperparameter values change, deployment will be triggered, (re)trains the model, and if the model meets minimum accuracy requirements, the model will be deployed.
    """
    )
